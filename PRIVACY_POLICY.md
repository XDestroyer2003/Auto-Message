## Auto Message: Privacy policy

Welcome to the Auto Message app for Android!

This app was made for learning developer learning purpose and making it a better app in the future

As developer beginner myself, I take privacy very seriously.
...
| `"android.permission.READ_PHONE_STATE" and "android.permission.READ_CONTACTS"` | Required to access contact which is easy for you to access the number of your desires recepients. |
| `"android.permission.SEND_SMS" ` | Required to send message  |

 <hr style="border:1px solid gray">

If you find any security vulnerability that has been inadvertently caused by me, or have any question regarding how the app protectes your privacy, please send me an email b, and I will surely try to fix it/help you.
